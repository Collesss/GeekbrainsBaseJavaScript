...
let descriptionProducts = ["Описание 1", "Описание 2", "Описание 3"];
...
function showMoreText(card) {
    ...
    let descriptionProduct = descriptionProducts[card.wrap.dataset.id];
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML('afterend', `<div class="desc">${descriptionProduct}</div>`)
