...
document.querySelectorAll('button').forEach(value => value.addEventListener('click', clickHandler));
...
function showCategory(category) {
    productsElem.innerHTML = products[category].map(getProductMarkup).join('\n'); 
}
